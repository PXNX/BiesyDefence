...
export class TranslationService {
  ...
  private getEnglishTranslations(): Record<string, string> {
    return {
      ...
      'controls.mute': 'Mute',
      'controls.unmute': 'Unmute audio',
      'app.language': 'Language',
      'app.wave_intel': 'Wave Intel',
      'app.money': 'Money',
      'app.lives': 'Lives',
      'app.wave': 'Wave',
      'app.achievements': 'Achievements',
      'app.play': 'Play',
      'app.how_to_play': 'How to play',
      'app.hide_tips': 'Hide tips',
      'app.start_eyebrow': 'Seed the Defense',
      'app.start_title': 'Play the prototype loop',
      'app.start_desc': 'Place towers, control the tempo, and push waves back. Deploy towers tactically before releasing each wave.',
      'app.how_to_play_towers': 'Tower Strategy',
      'app.how_to_play_indica': 'Heavy damage, slow fire rate - best for tough enemies',
      'app.how_to_play_sativa': 'Fast fire rate, lower damage - keeps enemies at bay',
      'app.how_to_play_support': 'Slows enemies down, no direct damage - pairs with shooters',
      'app.how_to_play_economy': 'Economy & Survival',
      'app.how_to_play_money': 'Earn money by defeating enemies',
      'app.how_to_play_lives': 'Lose lives when enemies reach the end',
      'app.how_to_play_build': 'Build strategically before starting waves',
      'app.how_to_play_keys': 'Keyboard Shortcuts',
      'app.shortcut_space': 'Start/Pause game',
      'app.shortcut_speed': 'Change game speed (1x, 2x, 4x)',
      'app.shortcut_next_wave': 'Start next wave',
      'app.shortcut_reset': 'Reset game',
      'app.shortcut_cancel': 'Cancel tower selection',
      'app.loading_audio': 'Loading audio...',
      'app.resetting': 'Resetting the prototype...',
      'app.preparing_map': 'Preparing the battle map...',
      'app.trophy': 'Trophy',
      'app.warning': 'Warning',
      'app.garden_secured': 'Garden Secured',
      'app.garden_lost': 'Garden Lost',
      'app.gameover_win_desc': 'You stood strong through the planned waves. Restart to test balance.',
      'app.gameover_loss_desc': 'The path was breached. Reset the prototype when you are ready to retry.',
      'app.retry': 'Retry',
