...
// Modifier caps derived from GAME_CONFIG
export const MODIFIER_CAPS: Partial<Record<ModifierType, { max: number }>> = {
  slow: { max: GAME_CONFIG.combat.modifierCaps.slow },
  armor_reduction: { max: GAME_CONFIG.combat.modifierCaps.armorReduction },
  damage_mult: { max: GAME_CONFIG.combat.modifierCaps.damageMult },
  vulnerability: { max: GAME_CONFIG.combat.modifierCaps.vulnerability },
};
