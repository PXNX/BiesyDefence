    ...
    perks: [
      {
        ...
        branch: 'A',
        cost: 60,
        effects: { slowMult: 0.9, slowDurationAdd: 0.6 },
      },
      {
        id: 'support-cryo-2',
        name: 'Freeze Pulse',
        ...
        branch: 'A',
        cost: 85,
        effects: { stunChance: 0.12, stunDuration: 0.8 },
      },
      {
        id: 'support-toxin-1',
        name: 'Toxin',
        ...
        branch: 'B',
        cost: 60,
        effects: { dotDpsMult: 1.25, slowMult: 1.08 },
      },
      {
        id: 'support-toxin-2',
        name: 'Virulent',
        ...
        branch: 'B',
        cost: 85,
        effects: { dotDurationAdd: 0.8, vulnerabilityAdd: 0.04 },
      },
    ],
  },
  sniper: {
    ...
    perks: [
      {
        ...
        branch: 'A',
        cost: 90,
        effects: { chainJumpsAdd: 0, splashRadiusAdd: 10, splashFactorAdd: 0.2 },
      },
      {
        id: 'sniper-pierce-2',
        name: 'Spall Burst',
        ...
        branch: 'A',
        cost: 110,
        effects: { splashFactorAdd: 0.25, fireRateMult: 0.9 },
      },
      {
        id: 'sniper-weak-1',
        name: 'Weakpoint',
        ...
        branch: 'B',
        cost: 90,
        effects: { critChance: 0.12, critMultiplier: 2.1, vulnerabilityAdd: 0.06 },
      },
      {
        id: 'sniper-weak-2',
        name: 'Execution',
        ...
        branch: 'B',
        cost: 110,
        effects: { critMultiplier: 2.4, markDuration: 1.5 },
      },
    ],
  },
  flamethrower: {
    ...
    perks: [
      ...
      },
      {
        ...
        branch: 'A',
        cost: 100,
        effects: { dotDpsMult: 1.2, dotDurationAdd: 0.8 },
      },
      {
        id: 'flame-pressure-1',
        name: 'Pressure',
        ...
        branch: 'B',
        cost: 80,
        effects: { damageMult: 1.2, rangeAdd: -10, critChance: 0.06, critMultiplier: 1.5 },
      },
      {
        id: 'flame-pressure-2',
        name: 'Burst Nozzle',
        ...
        branch: 'B',
        cost: 100,
        effects: { damageMult: 1.1, dotDpsMult: 1.15 },
      },
    ],
  },
  chain: {
    ...
    perks: [
      {
        ...
        branch: 'A',
        cost: 75,
        effects: { chainJumpsAdd: 1, chainFalloffMult: 0.95, stunChance: 0.08, stunDuration: 0.5 },
      },
      {
        id: 'chain-storm-2',
        name: 'Overload',
        ...
        branch: 'A',
        cost: 95,
        effects: { chainJumpsAdd: 1, chainFalloffMult: 0.92, stunChance: 0.12, stunDuration: 0.7 },
      },
      {
        id: 'chain-arc-1',
        name: 'Arc',
        ...
        branch: 'B',
        cost: 75,
        effects: { damageMult: 1.15, chainFalloffMult: 0.9, splashRadiusAdd: 8, splashFactorAdd: 0.15 },
      },
      {
        id: 'chain-arc-2',
        name: 'Supercharge',
        ...
        branch: 'B',
        cost: 95,
        effects: { damageMult: 1.12, splashRadiusAdd: 10, splashFactorAdd: 0.1 },
      },
    ],
  },
}
