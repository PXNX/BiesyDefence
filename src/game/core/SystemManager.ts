...
export class SystemManager {
  ...
  updateSystems(
    ...
    updateTowers(state, deltaSeconds, modifierManager, this.telemetry);

    // 3. Projectile System - moves projectiles and handles hits
    updateProjectiles(state, deltaSeconds, modifierManager, this.telemetry);
