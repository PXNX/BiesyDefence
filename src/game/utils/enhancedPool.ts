...
export const acquireProjectiles = (
  templates: Omit<Projectile, 'id'>[]
): Projectile[] => {
...
export const acquireParticles = (
  templates: Omit<Particle, 'id'>[]
): Particle[] => {
...
export const getPoolStats = (): PoolStats[] => {
  return [projectilePoolInstance.getStats(), particlePoolInstance.getStats()];
};
...
export const startAutoCleanup = (intervalMs: number = 30000): void => {
  // Every 30 seconds
  if (cleanupInterval) {
